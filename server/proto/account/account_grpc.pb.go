...
const (
	AccountService_CreateAccount_FullMethodName   = "/familyledger.account.v1.AccountService/CreateAccount"
	AccountService_ListAccounts_FullMethodName    = "/familyledger.account.v1.AccountService/ListAccounts"
	AccountService_GetAccount_FullMethodName      = "/familyledger.account.v1.AccountService/GetAccount"
	AccountService_UpdateAccount_FullMethodName   = "/familyledger.account.v1.AccountService/UpdateAccount"
	AccountService_DeleteAccount_FullMethodName   = "/familyledger.account.v1.AccountService/DeleteAccount"
	AccountService_TransferBetween_FullMethodName = "/familyledger.account.v1.AccountService/TransferBetween"
)
...
type AccountServiceClient interface {
	...
	TransferBetween(ctx context.Context, in *TransferBetweenRequest, opts ...grpc.CallOption) (*TransferBetweenResponse, error)
}
...
func (c *accountServiceClient) TransferBetween(ctx context.Context, in *TransferBetweenRequest, opts ...grpc.CallOption) (*TransferBetweenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TransferBetweenResponse)
	err := c.cc.Invoke(ctx, AccountService_TransferBetween_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountServiceServer interface {
	...
	TransferBetween(context.Context, *TransferBetweenRequest) (*TransferBetweenResponse, error)
...
func (UnimplementedAccountServiceServer) TransferBetween(context.Context, *TransferBetweenRequest) (*TransferBetweenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TransferBetween not implemented")
}
...
func _AccountService_TransferBetween_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferBetweenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountServiceServer).TransferBetween(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountService_TransferBetween_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountServiceServer).TransferBetween(ctx, req.(*TransferBetweenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "familyledger.account.v1.AccountService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TransferBetween",
			Handler:    _AccountService_TransferBetween_Handler,
		},
	},
