...
void main() {
  group('AnimatedCounter', () {
    ...
    testWidgets('shows correct final value after animation', (tester) async {
      await tester.pumpWidget(wrapInApp(const AnimatedCounter(value: 10050)));
    ...
    testWidgets('custom prefix', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedCounter(value: 5000, prefix: '\$')),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('custom decimal places', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedCounter(value: 12345, decimalPlaces: 0)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('useWanUnit shows 万 for large values', (tester) async {
      ...
      await tester.pumpWidget(
        wrapInApp(const AnimatedCounter(value: 1000000, useWanUnit: true)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('useWanUnit not applied for small values', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedCounter(value: 5000, useWanUnit: true)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('zero value', (tester) async {
      await tester.pumpWidget(wrapInApp(const AnimatedCounter(value: 0)));
      await tester.pumpAndSettle();
      expect(find.text('¥0.00'), findsOneWidget);
    });

    testWidgets('negative value', (tester) async {
      await tester.pumpWidget(wrapInApp(const AnimatedCounter(value: -5000)));
      await tester.pumpAndSettle();
      expect(find.text('¥-50.00'), findsOneWidget);
    });
    ...
    testWidgets('custom style is applied', (tester) async {
      ...
      await tester.pumpWidget(
        wrapInApp(const AnimatedCounter(value: 100, style: style)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('value update animates', (tester) async {
      ...
      // Update value
      await tester.pumpWidget(wrapInApp(const AnimatedCounter(value: 10000)));
  ...
  group('RollingCounter', () {
    testWidgets('renders with default params', (tester) async {
      await tester.pumpWidget(wrapInApp(const RollingCounter(value: 123.45)));
      expect(find.textContaining('¥'), findsOneWidget);
    });
    ...
    testWidgets('empty prefix hides prefix text', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const RollingCounter(value: 5.0, prefix: '')),
      );
    ...
    testWidgets('animates on value change', (tester) async {
      await tester.pumpWidget(wrapInApp(const RollingCounter(value: 0.0)));
      await tester.pumpAndSettle();

      await tester.pumpWidget(wrapInApp(const RollingCounter(value: 99.99)));
      // Pump a few frames
    ...
    testWidgets('custom decimalPlaces', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const RollingCounter(value: 5.5, decimalPlaces: 0)),
      );
      await tester.pumpAndSettle();
  ...
  group('AnimatedTabBar', () {
    ...
    testWidgets('tapping a tab calls onTap with correct index', (tester) async {
      int? tappedIndex;
      await tester.pumpWidget(
        wrapInApp(
          AnimatedTabBar(
    ...
    testWidgets('renders child', (tester) async {
      await tester.pumpWidget(
        wrapInApp(
          EasyRefresh(
            onRefresh: () async {},
            child: ListView(children: const [Text('Easy')]),
          ),
        ),
      );
  ...
  group('EmptyState', () {
    ...
    testWidgets('no action button when actionLabel is null', (tester) async {
      await tester.pumpWidget(
        wrapInApp(
          const EmptyState(icon: Icons.inbox, title: 'Empty', subtitle: 'Sub'),
        ),
      );
  ...
  group('EmptyState Presets', () {
    testWidgets('TransactionEmptyState', (tester) async {
      bool tapped = false;
      await tester.pumpWidget(
        wrapInApp(TransactionEmptyState(onAdd: () => tapped = true)),
      );
  ...
  group('ErrorState', () {
    testWidgets('renders default title and custom message', (tester) async {
      await tester.pumpWidget(wrapInApp(const ErrorState(message: '网络连接失败')));
    ...
    testWidgets('custom title', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const ErrorState(message: 'msg', title: '加载失败')),
      );
    ...
    testWidgets('retry button shows and works', (tester) async {
      bool retried = false;
      await tester.pumpWidget(
        wrapInApp(ErrorState(message: 'Error', onRetry: () => retried = true)),
      );
    ...
    testWidgets('no retry button when onRetry is null', (tester) async {
      await tester.pumpWidget(wrapInApp(const ErrorState(message: 'Error')));
    ...
    testWidgets('compact mode renders inline', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const ErrorState(message: 'Compact err', compact: true)),
      );
    ...
    testWidgets('compact mode without retry button', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const ErrorState(message: 'err', compact: true)),
      );
  ...
  group('SkeletonText', () {
    ...
    testWidgets('custom width, height, borderRadius', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const SkeletonText(width: 200, height: 20, borderRadius: 8)),
      );
      final container = tester.widget<Container>(find.byType(Container).first);
      expect(container, isNotNull);
    });
  ...
  group('SkeletonCard', () {
    testWidgets('renders with default height', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const SingleChildScrollView(child: SkeletonCard())),
      );
  ...
  group('SkeletonList', () {
    testWidgets('renders default 5 items', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const SingleChildScrollView(child: SkeletonList())),
      );
  ...
  group('SkeletonDashboard', () {
    testWidgets('renders without crash', (tester) async {
      ...
      addTearDown(() => FlutterError.onError = oldHandler);
      await tester.pumpWidget(
        wrapInApp(const SingleChildScrollView(child: SkeletonDashboard())),
      );
  ...
  group('ShimmerEffect', () {
    testWidgets('renders child and animates', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const ShimmerEffect(child: SizedBox(width: 100, height: 20))),
      );
  ...
  group('TransactionSuccessOverlay', () {
    testWidgets('renders amount and success text', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const TransactionSuccessOverlay(amount: '¥100.00')),
      );
    ...
    testWidgets('renders check icon', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const TransactionSuccessOverlay(amount: '¥50.00')),
      );
      await tester.pump();
    ...
    testWidgets('scale animation runs', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const TransactionSuccessOverlay(amount: '¥1.00')),
      );
      await tester.pumpAndSettle();
  ...
  group('SyncStatusIndicator', () {
    Override syncOverride(SyncState state) {
      return syncStatusProvider.overrideWith((ref) => _FakeSyncNotifier(state));
    }
    ...
    testWidgets('synced: shows nothing', (tester) async {
      await tester.pumpWidget(
        wrapInRiverpod(
          ...
          overrides: [syncOverride(const SyncState(status: SyncStatus.synced))],
        ),
      );
      await tester.pump();
  ...
  group('VirtualList', () {
    ...
    testWidgets('no emptyWidget and empty items shows nothing', (tester) async {
      await tester.pumpWidget(
        wrapInApp(
          VirtualList<String>(
            items: const [],
  ...
  group('TapScale', () {
    testWidgets('renders child', (tester) async {
      await tester.pumpWidget(wrapInApp(const TapScale(child: Text('Tap me'))));
    ...
    testWidgets('no onTap does not crash', (tester) async {
      await tester.pumpWidget(wrapInApp(const TapScale(child: Text('No tap'))));
    ...
    testWidgets('custom scaleFactor', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const TapScale(scaleFactor: 0.9, child: Text('Scale'))),
      );
  ...
  group('SlideInItem', () {
    testWidgets('renders child after delay', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const SlideInItem(index: 0, child: Text('Slide'))),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('index clamped to 10', (tester) async {
      ...
      await tester.pumpWidget(
        wrapInApp(const SlideInItem(index: 100, child: Text('Clamped'))),
      );
  ...
  group('AnimatedNumber', () {
    ...
    testWidgets('prefix and suffix', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedNumber(value: 5000, prefix: '¥', suffix: ' 元')),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('asWan shows 万 for large values', (tester) async {
      ...
      await tester.pumpWidget(
        wrapInApp(const AnimatedNumber(value: 1000000, useWanUnit: true)),
      );
      await tester.pumpAndSettle();
      expect(find.textContaining('万'), findsOneWidget);
    });
    ...
    testWidgets('asWan=false does not use 万', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedNumber(value: 1000000, useWanUnit: false)),
      );
      await tester.pumpAndSettle();
      expect(find.textContaining('万'), findsNothing);
    ...
    testWidgets('zero value', (tester) async {
      await tester.pumpWidget(wrapInApp(const AnimatedNumber(value: 0)));
      await tester.pumpAndSettle();
      expect(find.text('0.00'), findsOneWidget);
    });

    testWidgets('negative value', (tester) async {
      await tester.pumpWidget(wrapInApp(const AnimatedNumber(value: -5000)));
      await tester.pumpAndSettle();
      expect(find.text('-50.00'), findsOneWidget);
    });
    ...
    testWidgets('custom style', (tester) async {
      ...
      await tester.pumpWidget(
        wrapInApp(const AnimatedNumber(value: 100, style: style)),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('animates from old to new value', (tester) async {
      ...
      await tester.pumpWidget(wrapInApp(const AnimatedNumber(value: 10000)));
      // Mid-animation
      await tester.pump(const Duration(milliseconds: 100));
      // After settle
      await tester.pumpAndSettle();
  ...
  group('PulsingDot', () {
    testWidgets('renders with given color and size', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const PulsingDot(color: Colors.green, size: 12)),
      );
      expect(find.byType(PulsingDot), findsOneWidget);
    });

    testWidgets('default size is 8', (tester) async {
      await tester.pumpWidget(wrapInApp(const PulsingDot(color: Colors.red)));
    ...
    testWidgets('animation runs (pulsing)', (tester) async {
      await tester.pumpWidget(wrapInApp(const PulsingDot(color: Colors.blue)));
      await tester.pump(const Duration(milliseconds: 500));
      await tester.pump(const Duration(milliseconds: 500));
  ...
  group('AnimatedProgressBar', () {
    testWidgets('renders at 50% progress', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedProgressBar(progress: 0.5, color: Colors.blue)),
      );
    ...
    testWidgets('0% progress', (tester) async {
      await tester.pumpWidget(
        wrapInApp(
          const AnimatedProgressBar(progress: 0.0, color: Colors.green),
        ),
      );
      expect(find.byType(AnimatedProgressBar), findsOneWidget);
    });
    ...
    testWidgets('100% progress', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedProgressBar(progress: 1.0, color: Colors.red)),
      );
      expect(find.byType(AnimatedProgressBar), findsOneWidget);
    });
    ...
    testWidgets('progress clamped > 1.0', (tester) async {
      await tester.pumpWidget(
        wrapInApp(
          const AnimatedProgressBar(progress: 1.5, color: Colors.orange),
        ),
      );
    ...
    testWidgets('progress change animates', (tester) async {
      await tester.pumpWidget(
        wrapInApp(const AnimatedProgressBar(progress: 0.2, color: Colors.blue)),
      );
      await tester.pumpAndSettle();

      await tester.pumpWidget(
        wrapInApp(const AnimatedProgressBar(progress: 0.8, color: Colors.blue)),
      );
      await tester.pump(const Duration(milliseconds: 100));
      await tester.pumpAndSettle();
      expect(find.byType(AnimatedProgressBar), findsOneWidget);
