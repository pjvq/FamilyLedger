...
void main() {
  ...
  group('CategoryGrid', () {
    final categories = [
      ...
      _makeCategory(
        id: CategoryUUID.generate('test-user', 'expense', '购物'),
        name: '购物',
      ),
      _makeCategory(
        id: CategoryUUID.generate('test-user', 'expense', '居住'),
        name: '居住',
      ),
      _makeCategory(
        id: CategoryUUID.generate('test-user', 'expense', '娱乐'),
        name: '娱乐',
      ),
      _makeCategory(
        id: CategoryUUID.generate('test-user', 'expense', '医疗'),
        name: '医疗',
      ),
    ];
  ...
  group('NumberPad', () {
    testWidgets('renders all digit buttons 0-9, dot, delete, confirm', (
      ...
      await tester.pumpWidget(
        _wrap(NumberPad(onKey: (_) {}, onDelete: () {}, onConfirm: () {})),
      );
    ...
    testWidgets('zero button works', (tester) async {
      ...
      await tester.pumpWidget(
        _wrap(
          NumberPad(onKey: (k) => key = k, onDelete: () {}, onConfirm: () {}),
        ),
      );
    ...
    testWidgets('renders in dark theme', (tester) async {
      await tester.pumpWidget(
        _wrap(
          NumberPad(onKey: (_) {}, onDelete: () {}, onConfirm: () {}),
  ...
  group('AnimatedNumber', () {
    ...
    testWidgets('zero value renders 0.00', (tester) async {
      await tester.pumpWidget(
        _wrap(const AnimatedNumber(value: 0, prefix: '¥ ')),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('applies suffix', (tester) async {
      await tester.pumpWidget(
        _wrap(
          const AnimatedNumber(value: 5000, suffix: ' 元', useWanUnit: false),
        ),
      );
      await tester.pumpAndSettle();
