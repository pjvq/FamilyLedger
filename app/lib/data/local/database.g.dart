...
class SyncMetadataData extends DataClass
  ...
  SyncMetadataData copyWith({String? key, int? value}) =>
...
class $ExchangeRatesTable extends ExchangeRates
  ...
  @override
  List<GeneratedColumn> get $columns => [currencyPair, rate, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {currencyPair};
  @override
...
class ExchangeRate extends DataClass implements Insertable<ExchangeRate> {
  ...
  @override
  int get hashCode => Object.hash(currencyPair, rate, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $SyncDeadLettersTable extends SyncDeadLetters
    with TableInfo<$SyncDeadLettersTable, SyncDeadLetter> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $SyncDeadLettersTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  VerificationContext validateIntegrity(
    Insertable<SyncDeadLetter> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  @override
  SyncDeadLetter map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $SyncDeadLettersTable createAlias(String alias) {
    return $SyncDeadLettersTable(attachedDatabase, alias);
  }
}

class SyncDeadLetter extends DataClass implements Insertable<SyncDeadLetter> {
  final String opId;
  final String entityType;
  final String entityId;
  ...
  SyncDeadLettersCompanion toCompanion(bool nullToAbsent) {
  ...
  factory SyncDeadLetter.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  @override
  String toString() {
    return (StringBuffer('SyncDeadLetter(')
          ..write('opId: $opId, ')
          ..write('entityType: $entityType, ')
          ..write('entityId: $entityId, ')
          ..write('opType: $opType, ')
...
class SyncDeadLettersCompanion extends UpdateCompanion<SyncDeadLetter> {
  ...
  SyncDeadLettersCompanion copyWith({
    Value<String>? opId,
    Value<String>? entityType,
    Value<String>? entityId,
    Value<String>? opType,
  ...
  @override
  String toString() {
    return (StringBuffer('SyncDeadLettersCompanion(')
          ..write('opId: $opId, ')
          ..write('entityType: $entityType, ')
          ..write('entityId: $entityId, ')
          ..write('opType: $opType, ')
...
class $CloudKitSyncStateTable extends CloudKitSyncState
    with TableInfo<$CloudKitSyncStateTable, CloudKitSyncStateData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $CloudKitSyncStateTable(this.attachedDatabase, [this._alias]);
  ...
  static const VerificationMeta _changeTokenMeta = const VerificationMeta(
    'changeToken',
  );
  @override
  late final GeneratedColumn<String> changeToken = GeneratedColumn<String>(
    'change_token',
    aliasedName,
    true,
    type: DriftSqlType.string,
  ...
  @override
  List<GeneratedColumn> get $columns => [zone, changeToken, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'cloud_kit_sync_state';
  @override
  VerificationContext validateIntegrity(
    Insertable<CloudKitSyncStateData> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    ...
    if (data.containsKey('change_token')) {
      context.handle(
        _changeTokenMeta,
        changeToken.isAcceptableOrUnknown(
          data['change_token']!,
          _changeTokenMeta,
        ),
      );
  ...
  @override
  CloudKitSyncStateData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CloudKitSyncStateData(
      zone: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}zone'],
      )!,
      changeToken: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}change_token'],
      ),
      updatedAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}updated_at'],
  ...
  @override
  $CloudKitSyncStateTable createAlias(String alias) {
    return $CloudKitSyncStateTable(attachedDatabase, alias);
  }
}

class CloudKitSyncStateData extends DataClass
    implements Insertable<CloudKitSyncStateData> {
  final String zone;
  final String? changeToken;
  final DateTime updatedAt;
  const CloudKitSyncStateData({
    required this.zone,
    this.changeToken,
    required this.updatedAt,
  });
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || changeToken != null) {
      map['change_token'] = Variable<String>(changeToken);
    }
    map['updated_at'] = Variable<DateTime>(updatedAt);
    return map;
  }

  CloudKitSyncStateCompanion toCompanion(bool nullToAbsent) {
    return CloudKitSyncStateCompanion(
      zone: Value(zone),
      changeToken: changeToken == null && nullToAbsent
          ? const Value.absent()
          : Value(changeToken),
      updatedAt: Value(updatedAt),
    );
  ...
  factory CloudKitSyncStateData.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return CloudKitSyncStateData(
      ...
      changeToken: serializer.fromJson<String?>(json['changeToken']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'changeToken': serializer.toJson<String?>(changeToken),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
    };
  }

  CloudKitSyncStateData copyWith({
    String? zone,
    Value<String?> changeToken = const Value.absent(),
    DateTime? updatedAt,
  }) => CloudKitSyncStateData(
    zone: zone ?? this.zone,
    changeToken: changeToken.present ? changeToken.value : this.changeToken,
    updatedAt: updatedAt ?? this.updatedAt,
  );
  CloudKitSyncStateData copyWithCompanion(CloudKitSyncStateCompanion data) {
    return CloudKitSyncStateData(
      zone: data.zone.present ? data.zone.value : this.zone,
      changeToken: data.changeToken.present
          ? data.changeToken.value
          : this.changeToken,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
    );
  }
  ...
  @override
  String toString() {
    return (StringBuffer('CloudKitSyncStateData(')
          ..write('zone: $zone, ')
          ..write('changeToken: $changeToken, ')
          ..write('updatedAt: $updatedAt')
          ..write(')'))
        .toString();
  }
  ...
  @override
  int get hashCode => Object.hash(zone, changeToken, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CloudKitSyncStateData &&
          other.zone == this.zone &&
          other.changeToken == this.changeToken &&
          other.updatedAt == this.updatedAt);
}

class CloudKitSyncStateCompanion
    extends UpdateCompanion<CloudKitSyncStateData> {
  final Value<String> zone;
  final Value<String?> changeToken;
  final Value<DateTime> updatedAt;
  final Value<int> rowid;
  const CloudKitSyncStateCompanion({
    this.zone = const Value.absent(),
    this.changeToken = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  });
  CloudKitSyncStateCompanion.insert({
    required String zone,
    this.changeToken = const Value.absent(),
    this.updatedAt = const Value.absent(),
    this.rowid = const Value.absent(),
  }) : zone = Value(zone);
  static Insertable<CloudKitSyncStateData> custom({
    Expression<String>? zone,
    Expression<String>? changeToken,
    Expression<DateTime>? updatedAt,
    Expression<int>? rowid,
  }) {
    return RawValuesInsertable({
  ...
  CloudKitSyncStateCompanion copyWith({
    Value<String>? zone,
    Value<String?>? changeToken,
    Value<DateTime>? updatedAt,
    Value<int>? rowid,
  }) {
    return CloudKitSyncStateCompanion(
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (changeToken.present) {
      map['change_token'] = Variable<String>(changeToken.value);
    }
    if (updatedAt.present) {
      map['updated_at'] = Variable<DateTime>(updatedAt.value);
    }
  ...
  @override
  String toString() {
    return (StringBuffer('CloudKitSyncStateCompanion(')
          ..write('zone: $zone, ')
          ..write('changeToken: $changeToken, ')
          ..write('updatedAt: $updatedAt, ')
          ..write('rowid: $rowid')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $CloudKitSyncStateTable cloudKitSyncState =
      $CloudKitSyncStateTable(this);
  @override
...
final class $$UsersTableReferences
  ...
  static MultiTypedResultKey<
    $NotificationSettingsTableTable,
    List<NotificationSettingsTableData>
  >
  _notificationSettingsTableRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.notificationSettingsTable,
        aliasName: $_aliasNameGenerator(
          db.users.id,
          db.notificationSettingsTable.userId,
        ),
      );

  $$NotificationSettingsTableTableProcessedTableManager
  get notificationSettingsTableRefs {
    final manager = $$NotificationSettingsTableTableTableManager(
      $_db,
      $_db.notificationSettingsTable,
    ).filter((f) => f.userId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _notificationSettingsTableRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$UsersTableFilterComposer extends Composer<_$AppDatabase, $UsersTable> {
  ...
  Expression<bool> notificationSettingsTableRefs(
    Expression<bool> Function($$NotificationSettingsTableTableFilterComposer f)
    f,
  ) {
    final $$NotificationSettingsTableTableFilterComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.notificationSettingsTable,
          getReferencedColumn: (t) => t.userId,
          builder:
              (
                joinBuilder, {
                ...
                $db: $db,
                $table: $db.notificationSettingsTable,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
                $removeJoinBuilderFromRootComposer:
                    $removeJoinBuilderFromRootComposer,
...
class $$UsersTableAnnotationComposer
  ...
  Expression<T> notificationSettingsTableRefs<T extends Object>(
    Expression<T> Function($$NotificationSettingsTableTableAnnotationComposer a)
    f,
  ) {
    final $$NotificationSettingsTableTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.notificationSettingsTable,
    ...
    extends
        RootTableManager<
          ...
          PrefetchHooks Function({
            ...
            bool notificationSettingsTableRefs,
            bool loanGroupsRefs,
            bool loansRefs,
        ...
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                ...
                notificationSettingsTableRefs = false,
                ...
                return PrefetchHooks(
                  ...
                  explicitlyWatchedTables: [
                    ...
                    if (notificationSettingsTableRefs)
                      db.notificationSettingsTable,
                    ...
                    return [
                      ...
                      if (notificationSettingsTableRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$UsersTableReferences
                              ._notificationSettingsTableRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$UsersTableReferences(
                                db,
                                table,
                                p0,
                              ).notificationSettingsTableRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.userId == item.id,
                              ),
...
class $$BudgetsTableTableManager
    extends
        RootTableManager<
          ...
          Budget,
          PrefetchHooks Function({bool userId, bool categoryBudgetsTableRefs})
        > {
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({userId = false, categoryBudgetsTableRefs = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
...
final class $$NotificationSettingsTableTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $NotificationSettingsTableTable,
          NotificationSettingsTableData
        > {
  $$NotificationSettingsTableTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) => db.users.createAlias(
    $_aliasNameGenerator(db.notificationSettingsTable.userId, db.users.id),
  );
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$NotificationSettingsTableTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({userId = false}) {
...
typedef $$ExchangeRatesTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$SyncDeadLettersTableCreateCompanionBuilder =
    SyncDeadLettersCompanion Function({
      required String opId,
      required String entityType,
      required String entityId,
      required String opType,
...
class $$SyncDeadLettersTableFilterComposer
    extends Composer<_$AppDatabase, $SyncDeadLettersTable> {
  $$SyncDeadLettersTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SyncDeadLettersTableOrderingComposer
    extends Composer<_$AppDatabase, $SyncDeadLettersTable> {
  $$SyncDeadLettersTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SyncDeadLettersTableAnnotationComposer
    extends Composer<_$AppDatabase, $SyncDeadLettersTable> {
  $$SyncDeadLettersTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$SyncDeadLettersTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $SyncDeadLettersTable,
          SyncDeadLetter,
          $$SyncDeadLettersTableFilterComposer,
          $$SyncDeadLettersTableOrderingComposer,
          $$SyncDeadLettersTableAnnotationComposer,
          $$SyncDeadLettersTableCreateCompanionBuilder,
          $$SyncDeadLettersTableUpdateCompanionBuilder,
          (
            SyncDeadLetter,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$SyncDeadLettersTableTableManager(
    _$AppDatabase db,
    $SyncDeadLettersTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$SyncDeadLettersTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$SyncDeadLettersTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$SyncDeadLettersTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
...
typedef $$SyncDeadLettersTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $SyncDeadLettersTable,
      SyncDeadLetter,
      ...
      (
        SyncDeadLetter,
        BaseReferences<_$AppDatabase, $SyncDeadLettersTable, SyncDeadLetter>,
      ),
      SyncDeadLetter,
      PrefetchHooks Function()
    >;
...
typedef $$CategoryMergeDismissalsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$CloudKitSyncStateTableCreateCompanionBuilder =
    CloudKitSyncStateCompanion Function({
      required String zone,
      Value<String?> changeToken,
      Value<DateTime> updatedAt,
      Value<int> rowid,
    });
typedef $$CloudKitSyncStateTableUpdateCompanionBuilder =
    CloudKitSyncStateCompanion Function({
      Value<String> zone,
      Value<String?> changeToken,
      Value<DateTime> updatedAt,
...
class $$CloudKitSyncStateTableFilterComposer
    extends Composer<_$AppDatabase, $CloudKitSyncStateTable> {
  $$CloudKitSyncStateTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnFilters<String> get changeToken => $composableBuilder(
    column: $table.changeToken,
    builder: (column) => ColumnFilters(column),
  );
...
class $$CloudKitSyncStateTableOrderingComposer
    extends Composer<_$AppDatabase, $CloudKitSyncStateTable> {
  $$CloudKitSyncStateTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  ColumnOrderings<String> get changeToken => $composableBuilder(
    column: $table.changeToken,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$CloudKitSyncStateTableAnnotationComposer
    extends Composer<_$AppDatabase, $CloudKitSyncStateTable> {
  $$CloudKitSyncStateTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
  ...
  GeneratedColumn<String> get changeToken => $composableBuilder(
    column: $table.changeToken,
    builder: (column) => column,
  );
...
class $$CloudKitSyncStateTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $CloudKitSyncStateTable,
          CloudKitSyncStateData,
          $$CloudKitSyncStateTableFilterComposer,
          $$CloudKitSyncStateTableOrderingComposer,
          $$CloudKitSyncStateTableAnnotationComposer,
          $$CloudKitSyncStateTableCreateCompanionBuilder,
          $$CloudKitSyncStateTableUpdateCompanionBuilder,
          (
            CloudKitSyncStateData,
            BaseReferences<
              _$AppDatabase,
          ...
          PrefetchHooks Function()
        > {
  $$CloudKitSyncStateTableTableManager(
    _$AppDatabase db,
    $CloudKitSyncStateTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$CloudKitSyncStateTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$CloudKitSyncStateTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$CloudKitSyncStateTableAnnotationComposer(
                $db: db,
                $table: table,
...
typedef $$CloudKitSyncStateTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CloudKitSyncStateTable,
      CloudKitSyncStateData,
...
class $AppDatabaseManager {
  ...
  $$CloudKitSyncStateTableTableManager get cloudKitSyncState =>
      $$CloudKitSyncStateTableTableManager(_db, _db.cloudKitSyncState);
}
