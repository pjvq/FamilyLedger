...
class CategorySeeder {
  ...
  Future<void> _seedCategories(String ownerID) async {
    ...
    await _db.batch((b) => b.insertAllOnConflictUpdate(_db.categories, presets));
  }

  CategoriesCompanion _cat(String id, String name, String iconKey, String type, bool isPreset, int sort) =>
      CategoriesCompanion.insert(
        id: id, name: name, type: type,
        isPreset: Value(isPreset), sortOrder: Value(sort), iconKey: Value(iconKey),
      );

  CategoriesCompanion _subcat(String ownerID, String parentType, String parentName, String childName, String iconKey, int sort) {
    ...
    return CategoriesCompanion.insert(
      id: id, name: childName, type: parentType,
      isPreset: const Value(true), sortOrder: Value(sort),
      parentId: Value(parentId), iconKey: Value(iconKey),
    );
  }
