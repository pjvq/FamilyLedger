...
abstract final class ChartColors {
  // Individual named slots for const-context usage.
  // Names are positional (slot1..slot8) to avoid coupling to hue.
  ...
  /// Full chart palette for pie/bar/line charts (color-blind safe).
