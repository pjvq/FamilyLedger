...
class NotifyServiceClient extends $grpc.Client {
  ...
  static final _$getNotificationSettings = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $1.GetNotificationSettingsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.RegisterDeviceResponse> registerDevice(
      $1.RegisterDeviceRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$registerDevice, request, options: options);
  }

  $grpc.ResponseFuture<$1.UnregisterDeviceResponse> unregisterDevice(
      $1.UnregisterDeviceRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$unregisterDevice, request, options: options);
  }

  $grpc.ResponseFuture<$1.GetNotificationSettingsResponse>
      getNotificationSettings($1.GetNotificationSettingsRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getNotificationSettings, request,
        options: options);
  }

  $grpc.ResponseFuture<$1.UpdateNotificationSettingsResponse>
      updateNotificationSettings($1.UpdateNotificationSettingsRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateNotificationSettings, request,
        options: options);
  }

  $grpc.ResponseFuture<$1.ListNotificationsResponse> listNotifications(
      $1.ListNotificationsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listNotifications, request, options: options);
  }

  $grpc.ResponseFuture<$1.MarkAsReadResponse> markAsRead(
...
abstract class NotifyServiceBase extends $grpc.Service {
  ...
  NotifyServiceBase() {
    $addMethod($grpc.ServiceMethod<$1.RegisterDeviceRequest,
    ...
    $addMethod($grpc.ServiceMethod<$1.UnregisterDeviceRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.UnregisterDeviceRequest.fromBuffer(value),
        ($1.UnregisterDeviceResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.GetNotificationSettingsRequest,
            $1.GetNotificationSettingsResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.GetNotificationSettingsRequest.fromBuffer(value),
        ($1.GetNotificationSettingsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.UpdateNotificationSettingsRequest,
            $1.UpdateNotificationSettingsResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.UpdateNotificationSettingsRequest.fromBuffer(value),
        ($1.UpdateNotificationSettingsResponse value) =>
            value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.ListNotificationsRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.ListNotificationsRequest.fromBuffer(value),
  ...
  $async.Future<$1.RegisterDeviceResponse> registerDevice_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.RegisterDeviceRequest> request) async {
    return registerDevice(call, await request);
  }

  $async.Future<$1.UnregisterDeviceResponse> unregisterDevice_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.UnregisterDeviceRequest> request) async {
    return unregisterDevice(call, await request);
  }

  $async.Future<$1.GetNotificationSettingsResponse> getNotificationSettings_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.GetNotificationSettingsRequest> request) async {
    return getNotificationSettings(call, await request);
  }

  $async.Future<$1.UpdateNotificationSettingsResponse>
      updateNotificationSettings_Pre($grpc.ServiceCall call,
          $async.Future<$1.UpdateNotificationSettingsRequest> request) async {
    return updateNotificationSettings(call, await request);
  }

  $async.Future<$1.ListNotificationsResponse> listNotifications_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.ListNotificationsRequest> request) async {
    return listNotifications(call, await request);
  }

  $async.Future<$1.MarkAsReadResponse> markAsRead_Pre($grpc.ServiceCall call,
      $async.Future<$1.MarkAsReadRequest> request) async {
  ...
  $async.Future<$1.UnregisterDeviceResponse> unregisterDevice(
      $grpc.ServiceCall call, $1.UnregisterDeviceRequest request);
  $async.Future<$1.GetNotificationSettingsResponse> getNotificationSettings(
      $grpc.ServiceCall call, $1.GetNotificationSettingsRequest request);
  $async.Future<$1.UpdateNotificationSettingsResponse>
      updateNotificationSettings(
          $grpc.ServiceCall call, $1.UpdateNotificationSettingsRequest request);
  $async.Future<$1.ListNotificationsResponse> listNotifications(
      $grpc.ServiceCall call, $1.ListNotificationsRequest request);
  $async.Future<$1.MarkAsReadResponse> markAsRead(
      $grpc.ServiceCall call, $1.MarkAsReadRequest request);
}
