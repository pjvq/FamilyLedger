...
class MarketType extends $pb.ProtobufEnum {
  static const MarketType MARKET_TYPE_UNSPECIFIED =
      MarketType._(0, _omitEnumNames ? '' : 'MARKET_TYPE_UNSPECIFIED');
  static const MarketType MARKET_TYPE_A_SHARE =
      MarketType._(1, _omitEnumNames ? '' : 'MARKET_TYPE_A_SHARE');
  static const MarketType MARKET_TYPE_HK_STOCK =
      MarketType._(2, _omitEnumNames ? '' : 'MARKET_TYPE_HK_STOCK');
  static const MarketType MARKET_TYPE_US_STOCK =
      MarketType._(3, _omitEnumNames ? '' : 'MARKET_TYPE_US_STOCK');
  static const MarketType MARKET_TYPE_CRYPTO =
      MarketType._(4, _omitEnumNames ? '' : 'MARKET_TYPE_CRYPTO');
  static const MarketType MARKET_TYPE_FUND =
      MarketType._(5, _omitEnumNames ? '' : 'MARKET_TYPE_FUND');
  static const MarketType MARKET_TYPE_PRECIOUS_METAL =
      MarketType._(6, _omitEnumNames ? '' : 'MARKET_TYPE_PRECIOUS_METAL');
  ...
  static final $core.Map<$core.int, MarketType> _byValue =
...
class TradeType extends $pb.ProtobufEnum {
  ...
  static final $core.Map<$core.int, TradeType> _byValue =
      $pb.ProtobufEnum.initByValue(values);
