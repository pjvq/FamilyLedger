...
class TransactionServiceClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$0.BatchCreateTransactionsResponse>
      batchCreateTransactions(
    $0.BatchCreateTransactionsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$batchCreateTransactions, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$0.BatchDeleteTransactionsResponse>
      batchDeleteTransactions(
    $0.BatchDeleteTransactionsRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$batchDeleteTransactions, request,
        options: options);
  }

  $grpc.ResponseFuture<$0.UploadTransactionImageResponse>
      uploadTransactionImage(
    $0.UploadTransactionImageRequest request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$uploadTransactionImage, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$0.MergeCategoriesResponse> mergeCategories(
    $0.MergeCategoriesRequest request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$batchCreateTransactions = $grpc.ClientMethod<
          $0.BatchCreateTransactionsRequest,
          $0.BatchCreateTransactionsResponse>(
      '/familyledger.transaction.v1.TransactionService/BatchCreateTransactions',
      ($0.BatchCreateTransactionsRequest value) => value.writeToBuffer(),
      $0.BatchCreateTransactionsResponse.fromBuffer);
  ...
  static final _$batchDeleteTransactions = $grpc.ClientMethod<
          $0.BatchDeleteTransactionsRequest,
          $0.BatchDeleteTransactionsResponse>(
      ...
      $0.BatchDeleteTransactionsResponse.fromBuffer);
  static final _$uploadTransactionImage = $grpc.ClientMethod<
          $0.UploadTransactionImageRequest, $0.UploadTransactionImageResponse>(
      ...
      $0.UploadTransactionImageResponse.fromBuffer);
  ...
  static final _$mergeCategories =
      $grpc.ClientMethod<$0.MergeCategoriesRequest, $0.MergeCategoriesResponse>(
          '/familyledger.transaction.v1.TransactionService/MergeCategories',
          ($0.MergeCategoriesRequest value) => value.writeToBuffer(),
          $0.MergeCategoriesResponse.fromBuffer);
}
...
abstract class TransactionServiceBase extends $grpc.Service {
  ...
  TransactionServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.BatchCreateTransactionsRequest,
            $0.BatchCreateTransactionsResponse>(
        'BatchCreateTransactions',
        batchCreateTransactions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.BatchCreateTransactionsRequest.fromBuffer(value),
        ($0.BatchCreateTransactionsResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$0.BatchDeleteTransactionsRequest,
            $0.BatchDeleteTransactionsResponse>(
        'BatchDeleteTransactions',
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.BatchDeleteTransactionsRequest.fromBuffer(value),
        ($0.BatchDeleteTransactionsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UploadTransactionImageRequest,
            $0.UploadTransactionImageResponse>(
        'UploadTransactionImage',
        uploadTransactionImage_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.UploadTransactionImageRequest.fromBuffer(value),
    ...
    $addMethod($grpc.ServiceMethod<$0.MergeCategoriesRequest,
            $0.MergeCategoriesResponse>(
        'MergeCategories',
        mergeCategories_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.MergeCategoriesRequest.fromBuffer(value),
        ($0.MergeCategoriesResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.BatchCreateTransactionsResponse> batchCreateTransactions_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.BatchCreateTransactionsRequest> $request) async {
    return batchCreateTransactions($call, await $request);
  }

  $async.Future<$0.BatchCreateTransactionsResponse> batchCreateTransactions(
      $grpc.ServiceCall call, $0.BatchCreateTransactionsRequest request);
  ...
  $async.Future<$0.BatchDeleteTransactionsResponse> batchDeleteTransactions_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.BatchDeleteTransactionsRequest> $request) async {
    return batchDeleteTransactions($call, await $request);
  }

  $async.Future<$0.BatchDeleteTransactionsResponse> batchDeleteTransactions(
      $grpc.ServiceCall call, $0.BatchDeleteTransactionsRequest request);

  $async.Future<$0.UploadTransactionImageResponse> uploadTransactionImage_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.UploadTransactionImageRequest> $request) async {
    return uploadTransactionImage($call, await $request);
  }

  $async.Future<$0.UploadTransactionImageResponse> uploadTransactionImage(
      $grpc.ServiceCall call, $0.UploadTransactionImageRequest request);
  ...
  $async.Future<$0.MergeCategoriesResponse> mergeCategories_Pre(
      $grpc.ServiceCall $call,
      $async.Future<$0.MergeCategoriesRequest> $request) async {
    return mergeCategories($call, await $request);
  }

  $async.Future<$0.MergeCategoriesResponse> mergeCategories(
      $grpc.ServiceCall call, $0.MergeCategoriesRequest request);
}
