...
class Account extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.account.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'userId')
    ..aOS(3, _omitFieldNames ? '' : 'familyId')
    ..aOS(4, _omitFieldNames ? '' : 'name')
    ..e<AccountType>(5, _omitFieldNames ? '' : 'type', $pb.PbFieldType.OE,
...
class Transfer extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(3)
  set fromAccountId($core.String v) {
    $_setString(2, v);
  }
...
class CreateAccountRequest extends $pb.GeneratedMessage {
  ...
  @$pb.TagNumber(5)
  set initialBalance($fixnum.Int64 v) {
    $_setInt64(4, v);
  }
...
class GetAccountResponse extends $pb.GeneratedMessage {
  ...
  factory GetAccountResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory GetAccountResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class DeleteAccountResponse extends $pb.GeneratedMessage {
  ...
  factory DeleteAccountResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory DeleteAccountResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
...
class TransferBetweenRequest extends $pb.GeneratedMessage {
  ...
  factory TransferBetweenRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransferBetweenRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransferBetweenRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.account.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TransferBetweenRequest clone() =>
      TransferBetweenRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TransferBetweenRequest copyWith(
          void Function(TransferBetweenRequest) updates) =>
      super.copyWith((message) => updates(message as TransferBetweenRequest))
          as TransferBetweenRequest;
  ...
  static $pb.PbList<TransferBetweenRequest> createRepeated() =>
      $pb.PbList<TransferBetweenRequest>();
  @$core.pragma('dart2js:noInline')
  static TransferBetweenRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferBetweenRequest>(create);
...
class TransferBetweenResponse extends $pb.GeneratedMessage {
  ...
  factory TransferBetweenResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory TransferBetweenResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'TransferBetweenResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.account.v1'),
      createEmptyInstance: create)
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  TransferBetweenResponse clone() =>
      TransferBetweenResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  TransferBetweenResponse copyWith(
          void Function(TransferBetweenResponse) updates) =>
      super.copyWith((message) => updates(message as TransferBetweenResponse))
          as TransferBetweenResponse;
  ...
  static $pb.PbList<TransferBetweenResponse> createRepeated() =>
      $pb.PbList<TransferBetweenResponse>();
  @$core.pragma('dart2js:noInline')
  static TransferBetweenResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<TransferBetweenResponse>(create);
