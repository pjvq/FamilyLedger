...
class SyncOperation extends $pb.GeneratedMessage {
  ...
  factory SyncOperation.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SyncOperation.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.sync.v1'),
      createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'id')
    ..aOS(2, _omitFieldNames ? '' : 'entityType')
    ..aOS(3, _omitFieldNames ? '' : 'entityId')
    ..e<OperationType>(4, _omitFieldNames ? '' : 'opType', $pb.PbFieldType.OE,
    ...
    ..aOM<$3.Timestamp>(7, _omitFieldNames ? '' : 'timestamp',
...
class PushOperationsRequest extends $pb.GeneratedMessage {
  ...
  factory PushOperationsRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PushOperationsRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PushOperationsRequest',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.sync.v1'),
      createEmptyInstance: create)
    ..pc<SyncOperation>(
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PushOperationsRequest clone() =>
      PushOperationsRequest()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PushOperationsRequest copyWith(
          void Function(PushOperationsRequest) updates) =>
      super.copyWith((message) => updates(message as PushOperationsRequest))
          as PushOperationsRequest;
  ...
  static $pb.PbList<PushOperationsRequest> createRepeated() =>
      $pb.PbList<PushOperationsRequest>();
  @$core.pragma('dart2js:noInline')
  static PushOperationsRequest getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PushOperationsRequest>(create);
...
class PushOperationsResponse extends $pb.GeneratedMessage {
  ...
  factory PushOperationsResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PushOperationsResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      _omitMessageNames ? '' : 'PushOperationsResponse',
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.sync.v1'),
      createEmptyInstance: create)
    ..a<$core.int>(
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  PushOperationsResponse clone() =>
      PushOperationsResponse()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  PushOperationsResponse copyWith(
          void Function(PushOperationsResponse) updates) =>
      super.copyWith((message) => updates(message as PushOperationsResponse))
          as PushOperationsResponse;
  ...
  static $pb.PbList<PushOperationsResponse> createRepeated() =>
      $pb.PbList<PushOperationsResponse>();
  @$core.pragma('dart2js:noInline')
  static PushOperationsResponse getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<PushOperationsResponse>(create);
...
class PullChangesRequest extends $pb.GeneratedMessage {
  ...
  factory PullChangesRequest.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PullChangesRequest.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          _omitMessageNames ? '' : 'familyledger.sync.v1'),
      createEmptyInstance: create)
    ..aOM<$3.Timestamp>(1, _omitFieldNames ? '' : 'since',
        subBuilder: $3.Timestamp.create)
...
class PullChangesResponse extends $pb.GeneratedMessage {
  ...
  factory PullChangesResponse.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory PullChangesResponse.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<SyncOperation>(
        1, _omitFieldNames ? '' : 'operations', $pb.PbFieldType.PM,
        subBuilder: SyncOperation.create)
    ..aOM<$3.Timestamp>(2, _omitFieldNames ? '' : 'serverTime',
        subBuilder: $3.Timestamp.create)
