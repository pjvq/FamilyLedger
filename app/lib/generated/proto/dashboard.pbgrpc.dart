...
class DashboardServiceClient extends $grpc.Client {
  static final _$getNetWorth =
      $grpc.ClientMethod<$0.GetNetWorthRequest, $0.NetWorth>(
  ...
  static final _$getIncomeExpenseTrend =
      $grpc.ClientMethod<$0.TrendRequest, $0.TrendResponse>(
  ...
  static final _$getCategoryBreakdown = $grpc.ClientMethod<
          $0.CategoryBreakdownRequest, $0.CategoryBreakdownResponse>(
      '/familyledger.dashboard.v1.DashboardService/GetCategoryBreakdown',
      ($0.CategoryBreakdownRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.CategoryBreakdownResponse.fromBuffer(value));
  static final _$getBudgetSummary =
      $grpc.ClientMethod<$0.BudgetSummaryRequest, $0.BudgetSummaryResponse>(
          '/familyledger.dashboard.v1.DashboardService/GetBudgetSummary',
          ($0.BudgetSummaryRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.BudgetSummaryResponse.fromBuffer(value));
  static final _$getNetWorthTrend =
      $grpc.ClientMethod<$0.TrendRequest, $0.TrendResponse>(
  ...
  $grpc.ResponseFuture<$0.NetWorth> getNetWorth($0.GetNetWorthRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getNetWorth, request, options: options);
  }

  $grpc.ResponseFuture<$0.TrendResponse> getIncomeExpenseTrend(
      $0.TrendRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getIncomeExpenseTrend, request, options: options);
  }

  $grpc.ResponseFuture<$0.CategoryBreakdownResponse> getCategoryBreakdown(
      $0.CategoryBreakdownRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getCategoryBreakdown, request, options: options);
  }

  $grpc.ResponseFuture<$0.BudgetSummaryResponse> getBudgetSummary(
      $0.BudgetSummaryRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getBudgetSummary, request, options: options);
  }

  $grpc.ResponseFuture<$0.TrendResponse> getNetWorthTrend(
      $0.TrendRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class DashboardServiceBase extends $grpc.Service {
  ...
  DashboardServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.CategoryBreakdownRequest,
            $0.CategoryBreakdownResponse>(
        'GetCategoryBreakdown',
        getCategoryBreakdown_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.CategoryBreakdownRequest.fromBuffer(value),
        ($0.CategoryBreakdownResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.BudgetSummaryRequest, $0.BudgetSummaryResponse>(
            'GetBudgetSummary',
            getBudgetSummary_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.BudgetSummaryRequest.fromBuffer(value),
  ...
  $async.Future<$0.NetWorth> getNetWorth_Pre($grpc.ServiceCall call,
      $async.Future<$0.GetNetWorthRequest> request) async {
    return getNetWorth(call, await request);
  }

  $async.Future<$0.TrendResponse> getIncomeExpenseTrend_Pre(
      $grpc.ServiceCall call, $async.Future<$0.TrendRequest> request) async {
    return getIncomeExpenseTrend(call, await request);
  }

  $async.Future<$0.CategoryBreakdownResponse> getCategoryBreakdown_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.CategoryBreakdownRequest> request) async {
    return getCategoryBreakdown(call, await request);
  }

  $async.Future<$0.BudgetSummaryResponse> getBudgetSummary_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.BudgetSummaryRequest> request) async {
    return getBudgetSummary(call, await request);
  }

  $async.Future<$0.TrendResponse> getNetWorthTrend_Pre(
      $grpc.ServiceCall call, $async.Future<$0.TrendRequest> request) async {
    return getNetWorthTrend(call, await request);
  }

  $async.Future<$0.NetWorth> getNetWorth(
      $grpc.ServiceCall call, $0.GetNetWorthRequest request);
  $async.Future<$0.TrendResponse> getIncomeExpenseTrend(
      $grpc.ServiceCall call, $0.TrendRequest request);
  $async.Future<$0.CategoryBreakdownResponse> getCategoryBreakdown(
      $grpc.ServiceCall call, $0.CategoryBreakdownRequest request);
  $async.Future<$0.BudgetSummaryResponse> getBudgetSummary(
      $grpc.ServiceCall call, $0.BudgetSummaryRequest request);
  $async.Future<$0.TrendResponse> getNetWorthTrend(
      $grpc.ServiceCall call, $0.TrendRequest request);
}
