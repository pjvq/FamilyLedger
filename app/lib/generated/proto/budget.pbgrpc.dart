...
class BudgetServiceClient extends $grpc.Client {
  ...
  static final _$getBudget =
      $grpc.ClientMethod<$0.GetBudgetRequest, $0.GetBudgetResponse>(
          '/familyledger.budget.v1.BudgetService/GetBudget',
          ($0.GetBudgetRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.GetBudgetResponse.fromBuffer(value));
  ...
  static final _$getBudgetExecution = $grpc.ClientMethod<
          $0.GetBudgetExecutionRequest, $0.GetBudgetExecutionResponse>(
      '/familyledger.budget.v1.BudgetService/GetBudgetExecution',
      ($0.GetBudgetExecutionRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.GetBudgetExecutionResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.GetBudgetResponse> getBudget(
  ...
  $grpc.ResponseFuture<$0.GetBudgetExecutionResponse> getBudgetExecution(
      $0.GetBudgetExecutionRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class BudgetServiceBase extends $grpc.Service {
  ...
  BudgetServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.GetBudgetExecutionRequest,
            $0.GetBudgetExecutionResponse>(
        'GetBudgetExecution',
        getBudgetExecution_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.GetBudgetExecutionRequest.fromBuffer(value),
  ...
  $async.Future<$0.GetBudgetResponse> getBudget_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.GetBudgetExecutionResponse> getBudgetExecution_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetBudgetExecutionRequest> request) async {
  ...
  $async.Future<$0.GetBudgetResponse> getBudget(
  ...
  $async.Future<$0.GetBudgetExecutionResponse> getBudgetExecution(
      $grpc.ServiceCall call, $0.GetBudgetExecutionRequest request);
}
