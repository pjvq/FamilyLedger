...
class AccountServiceClient extends $grpc.Client {
  static final _$createAccount =
      $grpc.ClientMethod<$1.CreateAccountRequest, $1.CreateAccountResponse>(
          '/familyledger.account.v1.AccountService/CreateAccount',
          ($1.CreateAccountRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.CreateAccountResponse.fromBuffer(value));
  ...
  static final _$updateAccount =
      $grpc.ClientMethod<$1.UpdateAccountRequest, $1.UpdateAccountResponse>(
          '/familyledger.account.v1.AccountService/UpdateAccount',
          ($1.UpdateAccountRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.UpdateAccountResponse.fromBuffer(value));
  static final _$deleteAccount =
      $grpc.ClientMethod<$1.DeleteAccountRequest, $1.DeleteAccountResponse>(
          '/familyledger.account.v1.AccountService/DeleteAccount',
          ($1.DeleteAccountRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.DeleteAccountResponse.fromBuffer(value));
  static final _$transferBetween =
      $grpc.ClientMethod<$1.TransferBetweenRequest, $1.TransferBetweenResponse>(
          '/familyledger.account.v1.AccountService/TransferBetween',
          ($1.TransferBetweenRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.TransferBetweenResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.CreateAccountResponse> createAccount(
      $1.CreateAccountRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$1.UpdateAccountResponse> updateAccount(
      $1.UpdateAccountRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateAccount, request, options: options);
  }

  $grpc.ResponseFuture<$1.DeleteAccountResponse> deleteAccount(
      $1.DeleteAccountRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteAccount, request, options: options);
  }

  $grpc.ResponseFuture<$1.TransferBetweenResponse> transferBetween(
      $1.TransferBetweenRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class AccountServiceBase extends $grpc.Service {
  ...
  AccountServiceBase() {
    $addMethod(
        $grpc.ServiceMethod<$1.CreateAccountRequest, $1.CreateAccountResponse>(
            'CreateAccount',
            createAccount_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.CreateAccountRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$1.UpdateAccountRequest, $1.UpdateAccountResponse>(
            'UpdateAccount',
            updateAccount_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.UpdateAccountRequest.fromBuffer(value),
            ($1.UpdateAccountResponse value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$1.DeleteAccountRequest, $1.DeleteAccountResponse>(
            'DeleteAccount',
            deleteAccount_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.DeleteAccountRequest.fromBuffer(value),
            ($1.DeleteAccountResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.TransferBetweenRequest,
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.TransferBetweenRequest.fromBuffer(value),
        ($1.TransferBetweenResponse value) => value.writeToBuffer()));
  }

  $async.Future<$1.CreateAccountResponse> createAccount_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.CreateAccountRequest> request) async {
  ...
  $async.Future<$1.UpdateAccountResponse> updateAccount_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.UpdateAccountRequest> request) async {
    return updateAccount(call, await request);
  }

  $async.Future<$1.DeleteAccountResponse> deleteAccount_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.DeleteAccountRequest> request) async {
    return deleteAccount(call, await request);
  }

  $async.Future<$1.TransferBetweenResponse> transferBetween_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.TransferBetweenRequest> request) async {
    return transferBetween(call, await request);
  }

  $async.Future<$1.CreateAccountResponse> createAccount(
      $grpc.ServiceCall call, $1.CreateAccountRequest request);
  ...
  $async.Future<$1.UpdateAccountResponse> updateAccount(
      $grpc.ServiceCall call, $1.UpdateAccountRequest request);
  $async.Future<$1.DeleteAccountResponse> deleteAccount(
      $grpc.ServiceCall call, $1.DeleteAccountRequest request);
  $async.Future<$1.TransferBetweenResponse> transferBetween(
      $grpc.ServiceCall call, $1.TransferBetweenRequest request);
}
