...
class FamilyServiceClient extends $grpc.Client {
  static final _$createFamily =
      $grpc.ClientMethod<$0.CreateFamilyRequest, $0.CreateFamilyResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.CreateFamilyResponse.fromBuffer(value));
  static final _$joinFamily =
      $grpc.ClientMethod<$0.JoinFamilyRequest, $0.JoinFamilyResponse>(
          '/familyledger.family.v1.FamilyService/JoinFamily',
          ($0.JoinFamilyRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.JoinFamilyResponse.fromBuffer(value));
  static final _$getFamily =
      $grpc.ClientMethod<$0.GetFamilyRequest, $0.GetFamilyResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetFamilyResponse.fromBuffer(value));
  static final _$listMyFamilies =
      $grpc.ClientMethod<$0.ListMyFamiliesRequest, $0.ListMyFamiliesResponse>(
          '/familyledger.family.v1.FamilyService/ListMyFamilies',
          ($0.ListMyFamiliesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.ListMyFamiliesResponse.fromBuffer(value));
  static final _$generateInviteCode = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.GenerateInviteCodeResponse.fromBuffer(value));
  static final _$setMemberRole =
      $grpc.ClientMethod<$0.SetMemberRoleRequest, $0.SetMemberRoleResponse>(
          '/familyledger.family.v1.FamilyService/SetMemberRole',
          ($0.SetMemberRoleRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.SetMemberRoleResponse.fromBuffer(value));
  static final _$setMemberPermissions = $grpc.ClientMethod<
          $0.SetMemberPermissionsRequest, $0.SetMemberPermissionsResponse>(
      '/familyledger.family.v1.FamilyService/SetMemberPermissions',
      ($0.SetMemberPermissionsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.SetMemberPermissionsResponse.fromBuffer(value));
  static final _$listFamilyMembers = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) =>
          $0.ListFamilyMembersResponse.fromBuffer(value));
  static final _$leaveFamily =
      $grpc.ClientMethod<$0.LeaveFamilyRequest, $0.LeaveFamilyResponse>(
          '/familyledger.family.v1.FamilyService/LeaveFamily',
          ($0.LeaveFamilyRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.LeaveFamilyResponse.fromBuffer(value));
  ...
  static final _$deleteFamily =
      $grpc.ClientMethod<$0.DeleteFamilyRequest, $0.DeleteFamilyResponse>(
          '/familyledger.family.v1.FamilyService/DeleteFamily',
          ($0.DeleteFamilyRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.DeleteFamilyResponse.fromBuffer(value));
  static final _$getAuditLog =
      $grpc.ClientMethod<$0.GetAuditLogRequest, $0.GetAuditLogResponse>(
          ...
          ($core.List<$core.int> value) =>
              $0.GetAuditLogResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.JoinFamilyResponse> joinFamily(
  ...
  $grpc.ResponseFuture<$0.ListMyFamiliesResponse> listMyFamilies(
      $0.ListMyFamiliesRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.SetMemberRoleResponse> setMemberRole(
      $0.SetMemberRoleRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setMemberRole, request, options: options);
  }

  $grpc.ResponseFuture<$0.SetMemberPermissionsResponse> setMemberPermissions(
      $0.SetMemberPermissionsRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.LeaveFamilyResponse> leaveFamily(
  ...
  $grpc.ResponseFuture<$0.DeleteFamilyResponse> deleteFamily(
      $0.DeleteFamilyRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class FamilyServiceBase extends $grpc.Service {
  ...
  FamilyServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.ListMyFamiliesRequest,
            $0.ListMyFamiliesResponse>(
        'ListMyFamilies',
        listMyFamilies_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.ListMyFamiliesRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.SetMemberRoleRequest, $0.SetMemberRoleResponse>(
            'SetMemberRole',
            setMemberRole_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.SetMemberRoleRequest.fromBuffer(value),
            ($0.SetMemberRoleResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.SetMemberPermissionsRequest,
            $0.SetMemberPermissionsResponse>(
        'SetMemberPermissions',
        setMemberPermissions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.SetMemberPermissionsRequest.fromBuffer(value),
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.LeaveFamilyRequest, $0.LeaveFamilyResponse>(
            'LeaveFamily',
            leaveFamily_Pre,
            false,
            false,
    ...
    $addMethod(
        $grpc.ServiceMethod<$0.DeleteFamilyRequest, $0.DeleteFamilyResponse>(
            'DeleteFamily',
            deleteFamily_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.DeleteFamilyRequest.fromBuffer(value),
  ...
  $async.Future<$0.JoinFamilyResponse> joinFamily_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.ListMyFamiliesResponse> listMyFamilies_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.ListMyFamiliesRequest> request) async {
  ...
  $async.Future<$0.SetMemberRoleResponse> setMemberRole_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.SetMemberRoleRequest> request) async {
    return setMemberRole(call, await request);
  }

  $async.Future<$0.SetMemberPermissionsResponse> setMemberPermissions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.SetMemberPermissionsRequest> request) async {
  ...
  $async.Future<$0.LeaveFamilyResponse> leaveFamily_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$0.DeleteFamilyResponse> deleteFamily_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.DeleteFamilyRequest> request) async {
  ...
  $async.Future<$0.JoinFamilyResponse> joinFamily(
  ...
  $async.Future<$0.ListMyFamiliesResponse> listMyFamilies(
      $grpc.ServiceCall call, $0.ListMyFamiliesRequest request);
  $async.Future<$0.GenerateInviteCodeResponse> generateInviteCode(
      $grpc.ServiceCall call, $0.GenerateInviteCodeRequest request);
  $async.Future<$0.SetMemberRoleResponse> setMemberRole(
      $grpc.ServiceCall call, $0.SetMemberRoleRequest request);
  $async.Future<$0.SetMemberPermissionsResponse> setMemberPermissions(
      $grpc.ServiceCall call, $0.SetMemberPermissionsRequest request);
  $async.Future<$0.ListFamilyMembersResponse> listFamilyMembers(
      $grpc.ServiceCall call, $0.ListFamilyMembersRequest request);
  $async.Future<$0.LeaveFamilyResponse> leaveFamily(
  ...
  $async.Future<$0.DeleteFamilyResponse> deleteFamily(
      $grpc.ServiceCall call, $0.DeleteFamilyRequest request);
