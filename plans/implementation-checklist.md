...
> Last updated: 2026-04-24 15:20 (132 commits)
...
| 3 | **budget/loan/asset/investment 家庭权限** | P3 | ✅ `f0ecf36` |
| 4 | **批量删除交易** | P3 | ✅ `585b133` |
| 5 | **交易图片附件验证** | P3 | ✅ `2bcaa1f` |
| 6 | **60fps 实机验证** | P3 | 0.5 天 |
| 7 | **Go 后端剩余 9 service 测试** | P3 | 2-3 天 |
