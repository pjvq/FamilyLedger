...
| Phase 1c: 分类管理 | ✅ | ✅ | **95%** | 主/子分类+图标库+CRUD 完成，待真机验证 |
...
| ~~**分类管理 0%**~~ ✅ | ~~🔴 高~~ | Phase 1c 已完成: DB parent_id + 52 子分类 seed, Proto 4 个 CRUD RPC, Go 后端树形返回, Flutter 图标库+两级选择+管理页 |
...
| 优先级 | 工作 | 预估 | 理由 |
|--------|------|------|------|
| ~~**P0**~~ ✅ | ~~Phase 1c: 分类管理~~ | ✅ | DB+Proto+Go+Flutter 全链路完成 |
